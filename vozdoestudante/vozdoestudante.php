...
<body>
    ...
    <h4 class="text-center p-3 font-weight-bold">Voz do Estudante</h4>
    ...
    <div class="p-3 ">
        ...
        <a href="gremio.php" class="badge badge-success rounded mx-auto d-block" style="width: 200px; height: 23px; font-size: 15px;">Saber mais sobre!</a>
    </div>
    ...
    <div class="p-3">
        <h6 class="text-center"><u>Egressos</u></h6>
    </div>
    ...
    <div class="p-3">
        <h5 class="text-center p-3">Destaques</h5>
    </div>

    <!--DESTAQUE 1-->
    <div class="card rounded mx-auto d-block border border-dark p-1 shadow-lg mb-5 bg-white rounded" style="width: 23rem;">
        ...
        <div class="card-body">
            ...
            <p class="card-text text-justify ">O professor Wilson, representando a equipe de matemática, realizou a cerimônia de entrega de prêmios aos medalhistas do Campus Patrocínio, vencedores da Olimpíada Brasileira de Matemática das Escolas Públicas (OBMEP) e do concurso Canguru.</p>
        </div>
    </div>
    ...
    <div class="card rounded mx-auto d-block border border-dark p-1 shadow-lg mb-5 bg-white rounded" style="width: 23rem;">
        ...
        <div class="card-body">
            ...
            <p class="card-text text-justify ">O IFTM Campus Patrocínio participou pela primeira vez da Olimpíada Brasileira de Língua Inglesa (OBLI), aplicada em todo Brasil, em diferentes níveis. A instituição contou com a participação de vários alunos dos cursos técnicos integrados ao Ensino Médio. </p>
        </div>
    </div>
    ...
    <div class="card rounded mx-auto d-block border border-dark p-1 shadow-lg mb-5 bg-white rounded" style="width: 23rem;">
        ...
        <div class="card-body">
            ...
            <p class="card-text text-justify ">O Festival Cultural foi um sucesso! A noite do dia 31 de Agosto foi recheada de momentos especiais. As apresentações artísticas de estudantes, servidores e convidados presentearam as famílias do Campus Patrocínio na nossa comemoração de aniversário.</p>
        </div>
    </div>
    ...
    <div class="card rounded mx-auto d-block border border-dark p-1 shadow-lg mb-5 bg-white rounded" style="width: 23rem;">
        ...
        <div class="card-body">
            ...
            <p class="card-text text-justify ">No dia 08 de outubro, professor e alunos da disciplina de Produção, Estoque e Logística do segundo período do curso técnico em administração integrado ao ensino médio participaram de uma visita técnica na Fábrica da Nestlé de Ibiá/MG.</p>
        </div>
    </div>
    ...
    <div class="card rounded mx-auto d-block border border-dark p-1 shadow-lg mb-5 bg-white rounded" style="width: 23rem;">
        ...
        <div class="card-body">
            ...
            <p class="card-text text-justify ">Parabéns aos formandos dos cursos de Engenharia Elétrica, de Análise e Desenvolvimento de Sistemas e de Gestão Comercial pela conquista! O IFTM Campus Patrocínio tem orgulho de fazer parte de pessoas tão incríveis.</p>
        </div>
    </div>
